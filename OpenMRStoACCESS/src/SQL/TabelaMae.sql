...
left join (	SELECT 	o.person_id,e.encounter_id,o.value_text as nome
			...
			WHERE 	e.encounter_type in (7) and o.concept_id=1477 and o.voided=0 and e.voided=0
			) nome on nome.encounter_id=e.encounter_id

left join (	SELECT 	o.person_id,e.encounter_id,o.value_numeric as idade
			FROM 	encounter e 
					inner join obs o on e.encounter_id=o.encounter_id and o.person_id=e.patient_id
			WHERE 	e.encounter_type in (7) and o.concept_id=1478 and o.voided=0 and e.voided=0
...
left join (	SELECT 	o.person_id,e.encounter_id,
           ...
           WHERE 	e.encounter_type=7 and o.concept_id=1479 and o.voided=0 and e.voided=0		   
...
left join (	SELECT 	o.person_id,e.encounter_id,
			...
			FROM 	encounter e 					
					inner join obs o on e.encounter_id=o.encounter_id 
           WHERE 	e.encounter_type=7 and o.concept_id=1480 and o.voided=0 and e.voided=0		   
		   ) doente on doente.encounter_id=e.encounter_id

left join (	SELECT 	o.person_id,e.encounter_id,o.value_text as doenca
			FROM 	encounter e 
					inner join obs o on e.encounter_id=o.encounter_id and o.person_id=e.patient_id
			WHERE 	e.encounter_type in (7) and o.concept_id=1481 and o.voided=0 and e.voided=0
			) doenca on doenca.encounter_id=e.encounter_id

left join (	SELECT 	o.person_id,e.encounter_id,o.value_text as codprofissao
			FROM 	encounter e 
					inner join obs o on e.encounter_id=o.encounter_id and o.person_id=e.patient_id
			WHERE 	e.encounter_type in (7) and o.concept_id=1482 and o.voided=0 and e.voided=0
...
left join (	SELECT 	o.person_id,e.encounter_id,
			...
			FROM 	encounter e 					
					inner join obs o on e.encounter_id=o.encounter_id 
           WHERE 	e.encounter_type=7 and o.concept_id=1483 and o.voided=0 and e.voided=0		   
...
left join (	SELECT 	o.person_id,e.encounter_id,
			...
			FROM 	encounter e 					
					inner join obs o on e.encounter_id=o.encounter_id 
           WHERE 	e.encounter_type=7 and o.concept_id=1484 and o.voided=0 and e.voided=0		   
		   ) emtarv on emtarv.encounter_id=e.encounter_id

where e.encounter_type in (7) and  e.voided=0 and nome.nome is not null and p.dataabertura between '2007-01-01' and '2011-12-31';