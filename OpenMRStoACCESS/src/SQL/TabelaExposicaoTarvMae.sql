...
inner join (	SELECT 	o.person_id,e.encounter_id,
          ...
          when 628 then '3TC'
           ...
           WHERE 	e.encounter_type=7 and o.concept_id=1504 and o.voided=0 and e.voided=0
...
left join  (SELECT distinct o.person_id,o.encounter_id,cn.name as tarv
           ...
           where e.encounter_type=7 and o.concept_id=1504 and o.value_coded in (631,797,792,1800,1801,630,628) and o.voided=0 and cn.voided=0 and e.voided=0) 
